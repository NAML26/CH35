...
public class ArrayListCollections {
	 ...
	 * {}*/
		...
		System.out.println(film3);//Devuelve el index de la lista sin modificar = Pulp Fiction

		System.out.println(films); //Debuelve la ArrayList con el cambio en el 3
		
		String film3Get = films.get(3); 
		System.out.println(film3Get);//Devuelve el nuevo valor del 3=Memento 
		...
		//Agregar un elemento y después elminiarlo
		films.add("The fountain");
		System.out.println(films); //ArrayList actualizada + THe fountain
		
		films.remove(7);
		System.out.println(films); //ArrayList actualizada - The fountain
		
		//Mostrando elementos del ArrayList en lista, y no como String
